  ...
  return useMutation({
    ...
    onError: (error: any) => {
      ...
      toaster.create({
        ...
        description:
          "Ha ocurrido un error al intentar crear el banco: " + errorMessage,
        type: "error",
      });
    },
  });
  ...
  return useMutation({
    ...
    onError: (error: any) => {
      ...
      toaster.create({
        ...
        description:
          "Ha ocurrido un error al intentar actualizar el banco: " +
          errorMessage,
        type: "error",
      });
    },
...
export const useDeleteBank = () => {
  ...
  return useMutation({
    ...
    onSuccess: () => {
      toaster.create({
        title: "Banco actualizado",
        description: "El banco ha cambiado su estado exitosamente.",
      });
      queryClient.invalidateQueries({ queryKey: bankKeys.all });
    },
    onError: (error: any) => {
      ...
      toaster.create({
        title: "Error al actualizar el banco",
        description:
          "Ha ocurrido un error al intentar cambiar el estado del banco: " +
          errorMessage,
        type: "error",
      });
    },
